/**
 * Premium 3D Metallic Gold Bestseller Badge with Custom Logo
 * Features your cityscape/swirl logo in the center
 */
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 ${width} ${height}" width="${width}" height="${height}">
  <defs>
    ...
    <radialGradient id="specularIntense" cx="28%" cy="22%" r="35%" fx="28%" fy="22%">
      ...
      <stop offset="30%" stop-color="rgba(255,255,240,0.4)"/>
      <stop offset="60%" stop-color="rgba(255,248,200,0.15)"/>
...
await Bun.write('/tmp/images/bestseller-with-logo.svg', svg);
console.log('SVG with logo created: /tmp/images/bestseller-with-logo.svg');
...
await Bun.write('/tmp/images/bestseller-with-logo.png', pngBuffer);
console.log('PNG with logo created: /tmp/images/bestseller-with-logo.png');
