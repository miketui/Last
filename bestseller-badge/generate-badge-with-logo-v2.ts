/**
 * Premium 3D Metallic Gold Bestseller Badge with Custom Logo - V2
 * Logo properly clipped and blended
 */
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 ${width} ${height}" width="${width}" height="${height}">
  <defs>
    ...
    <!-- Center gold for logo background -->
  ...
  <g filter="url(#medalShadow)">
    ...
    <circle cx="${centerX - 1}" cy="${centerY - 1}" r="197"
            fill="none"
            stroke="url(#goldSharp)"
            stroke-width="3"
...
await Bun.write('/tmp/images/bestseller-with-logo-v2.svg', svg);
console.log('SVG with logo V2 created: /tmp/images/bestseller-with-logo-v2.svg');
...
await Bun.write('/tmp/images/bestseller-with-logo-v2.png', pngBuffer);
console.log('PNG with logo V2 created: /tmp/images/bestseller-with-logo-v2.png');
